...
const styles = StyleSheet.create({
  ...
  headerSub: { color: Colors.textSecondary, ...Typography.sm },
  body: { padding: Spacing.base, gap: Spacing.md },
  section: { gap: 10 },
  sectionLabel: { color: Colors.textSecondary, ...Typography.sm, fontWeight: "600" },
  ...
  dayChipNum: { color: Colors.textSecondary, ...Typography.xl, fontWeight: "700" },
  dayChipNumActive: { color: "#8b5cf6" },
  dayChipLabel: { color: Colors.textMuted, ...Typography.xs },
  ...
  goalInfo: { flex: 1 },
  goalKey: { color: Colors.textPrimary, ...Typography.sm, fontWeight: "600" },
  goalKeyActive: { color: "#8b5cf6" },
  goalDesc: { color: Colors.textMuted, ...Typography.xs },
  generateBtn: {
    flexDirection: "row",
    alignItems: "center",
  ...
  generateBtnText: { color: "#fff", ...Typography.md, fontWeight: "700" },
  weekGoalCard: {
    flexDirection: "row",
    alignItems: "center",
    gap: 12,
  ...
  weekGoalText: { color: "#fff", ...Typography.sm, flex: 1, lineHeight: 20 },
  planSection: { backgroundColor: Colors.bgCard, borderRadius: Radius.xl, overflow: "hidden" },
  planTitle: { color: Colors.textPrimary, ...Typography.md, fontWeight: "700", padding: Spacing.base, paddingBottom: 8 },
  planItem: {
    flexDirection: "row",
    alignItems: "center",
    gap: 12,
  ...
  planDay: { ...Typography.xs, fontWeight: "700" },
  planInfo: { flex: 1 },
  planWorkout: { color: Colors.textPrimary, ...Typography.sm, fontWeight: "600" },
  planReason: { color: Colors.textMuted, ...Typography.xs, marginTop: 2 },
  ...
  tipsTitle: { color: Colors.textPrimary, ...Typography.md, fontWeight: "700" },
  tipItem: { color: Colors.textSecondary, ...Typography.sm, lineHeight: 20 },
});
